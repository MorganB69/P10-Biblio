 ...
 * 
 */
@WebFault(name = "NotFoundException", targetNamespace = "http://identification.soap.biblio.mb.fr/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: fr.mb.biblio.webappConsumer.services.identification.NotFoundException
     */
