 ...
 * 
 */
@WebFault(name = "NotFoundException", targetNamespace = "http://contract.userService.soap.biblio.mb.fr/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: fr.mb.biblio.webappConsumer.services.user.NotFoundException
     */
