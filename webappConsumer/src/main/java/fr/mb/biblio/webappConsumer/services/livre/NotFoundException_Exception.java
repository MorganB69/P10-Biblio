 ...
 * 
 */
@WebFault(name = "NotFoundException", targetNamespace = "http://contract.livreService.soap.biblio.mb.fr/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: fr.mb.biblio.webappConsumer.services.livre.NotFoundException
     */
