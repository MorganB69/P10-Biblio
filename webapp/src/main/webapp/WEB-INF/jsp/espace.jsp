...
<div class="container" id="detail-cont">
    ...
    <section>
        ...
        <h2 class="text-center text-uppercase">Espace Personnel de <s:property value="#session.user.identifiant"/>
        </h2>
        <div class="row">
            <div class="col-xs-12 col-md-8 col-lg-8" id="left-column">


                <h5 class="collapsible-title mt-3" data-toggle="collapse" data-target="#associated-prets"
                    aria-expanded="true" aria-controls="associated-prets">
                                        ...
                                        <div class="card ">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <img class="img-fluid" id="img-card"
                                                         src="images/livre/<s:property value="livre.image"/>" alt="">
                                                </div>
                                        ...
                                        <div class="card-body m-2 border border-primary rounded">
                                            ...
                                            <div class="row">
                                                <ul class="m-1" id="listeLivre">
                                                    <li><b>Date de début : </b> <span
                                                            id="attribut"><javatime:parseLocalDate value="${dateDebut}"
                                                                                                   pattern="yyyy-MM-dd"
                                                                                                   var="date"/><javatime:format
                                                            value="${date}" pattern="dd-MM-yyyy"/></span></li>
                                                    <li><b>Date de fin prévue : </b><span
                                                            id="attribut"><javatime:parseLocalDate value="${dateFin}"
                                                                                                   pattern="yyyy-MM-dd"
                                                                                                   var="date"/><javatime:format
                                                            value="${date}" pattern="dd-MM-yyyy"/></span></li>
                                                    <li><b>Prolongé :</b><span id="attribut"><s:if
                                                            test="prolonge==true"> Oui</s:if><s:else> Non</s:else></span>
                                                    </li>
                                                    <s:if test="%{dateFin.isBefore(dateJour)}">
                                                        <i class="fa fa-times-circle m-1" id="iconStatutIndispo"></i>
                                                        <span id="statutIndispo">Attention, vous êtes en retard sur ce prêt</span>
                                                    </s:if>
                                            ...
                                            <s:if test="prolonge==false">
                                                ...
                                                <s:else>
                                                    <s:a class="btn btn-success m-3"
                                                         action="prolongerPret">Prolonger le prêt
            ...
            <div class="col-xs-12 col-md-4 col-lg-4" id="right-column">
                ...
                <h5 class="mt-3" data-toggle="collapse" href="#associated-situ" aria-expanded="true"
                    aria-controls="associated-situ">
