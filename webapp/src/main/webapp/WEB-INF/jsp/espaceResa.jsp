    ...
    <section>
        ...
        <div class="row">
            <div class="col-xs-12 col-md-8 col-lg-8" id="left-column">
                ...
                <h5 class="collapsible-title mt-3" data-toggle="collapse" data-target="#associated-resa"
                    aria-expanded="true" aria-controls="associated-resa">
                                            ...
                                            <div class="card-body">
                                                <div class="row justify-content-center">
                                                    ...
                                                    <img class="img-fluid" id="img-card"
                                                         src="images/livre/<s:property value="reservation.livre.image"/>"
                                                         alt="">
                                                </div>
                                                ...
                                                <ul class="m-1" id="listeLivre">
                                                    <s:if test="dateRetour!=null">
                                                        <li><b>Retour prévu le : </b> <span
                                                                ...
                                                                var="date"/><javatime:format value="${date}"
                                                                                             pattern="dd-MM-yyyy"/></span>
                                                        </li>
                                                    </s:if>
                                                    <s:if test="reservation.debutResa!=null">
                                                        <li><b>Commencée le : </b> <span
                                                                id="attribut"><javatime:parseLocalDate
                                                                value="${reservation.debutResa}" pattern="yyyy-MM-dd"
                                                                var="date"/><javatime:format value="${date}"
                                                                                             pattern="dd-MM-yyyy"/></span>
                                                        </li>
                                                    </s:if>
                                                    <s:if test="reservation.finResa!=null">
                                                        <li><b>Sera terminée le : </b><span
                                                                id="attribut"><javatime:parseLocalDate
                                                                value="${reservation.finResa}" pattern="yyyy-MM-dd"
                                                                var="date"/><javatime:format value="${date}"
                                                                                             pattern="dd-MM-yyyy"/></span>
                                                        </li>
                                                    </s:if>
                                                    <li><b>Position file d'attente :</b><span id="attribut"><s:property
                                                            value="positionUser"/>/<s:property
                                                            value="nbResaTotal"/> </span></li>
                                                </ul>
                                            </div>
