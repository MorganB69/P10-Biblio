 ...
 * generated in the fr.mb.biblio.webapp.services.user package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: fr.mb.biblio.webapp.services.user
     * 
     */
