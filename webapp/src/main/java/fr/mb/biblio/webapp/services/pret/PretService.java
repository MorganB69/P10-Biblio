...
public interface PretService {
    ...
    @RequestWrapper(localName = "retourPret", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.RetourPret")
    @ResponseWrapper(localName = "retourPretResponse", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.RetourPretResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPretsEnCours", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.GetPretsEnCours")
    @ResponseWrapper(localName = "getPretsEnCoursResponse", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.GetPretsEnCoursResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPretById", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.GetPretById")
    @ResponseWrapper(localName = "getPretByIdResponse", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.GetPretByIdResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getPretsRetards", targetNamespace = "http://contract.pretService.soap.biblio.mb.fr/", className = "fr.mb.biblio.webapp.services.pret.GetPretsRetards")
