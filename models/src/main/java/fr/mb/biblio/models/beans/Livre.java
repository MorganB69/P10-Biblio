...
public class Livre implements java.io.Serializable {
    ...
    private Set<Reservation> listeResa = new TreeSet<>();


    public Livre() {
    }

    public Livre(int idLivre, Ouvrage ouvrage, String titre, LocalDate parution, String image, String resume, Boolean disponible,int exemplaire) {
    ...
    public Livre(int idLivre, Ouvrage ouvrage, String titre, LocalDate parution, String image, String resume, Boolean disponible, int exemplaire,
                 Set<Auteur> auteurs, Set<Genre> genres, Set<Editeur> editeurs, Set<Pret> prets, Set<Reservation> listeResa) {
        this.idLivre = idLivre;
        this.ouvrage = ouvrage;
        this.titre = titre;
        this.parution = parution;
    ...
    public void setListeResa(Set<Reservation> listeResa) {
        this.listeResa = listeResa;
    }
}
